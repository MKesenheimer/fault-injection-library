...
On Linux, your user must have permissions to connect to the Pico Glitchers tty port. If not already done, add your user to the `dialout` group and restart your computer:
...
Install `findus` and the optional `rd6006` library:
