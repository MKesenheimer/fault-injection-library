...
class Main:
    ...
    def run(self):
        ...
        while True:
            ...
            # check for successive errors, exit if too many successive errors occur.
            self.error_handler.check(experiment_id=experiment_id, response=response, expected=b'expected')
