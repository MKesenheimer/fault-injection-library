...
class Main():
    def __init__(self, args):
        ...
        #self.glitcher.tio_trigger(pin_trigger=args.trigger_input, edge_type="rising")
        self.glitcher.edge_count_trigger(pin_trigger=args.trigger_input, number_of_edges=3, edge_type="rising")
